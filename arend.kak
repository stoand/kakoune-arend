...
add-highlighter shared/arend/code/ regex (?<!`)[A-z0-9'~!@#$%^&*\-+=<>?/\|[\]:_]+ 0:variable
...
add-highlighter shared/arend/code/ regex (?<=[\{\(\s])(-?)[0-9]+ 0:value
add-highlighter shared/arend/code/ regex \s(?:->|=>|_|:|\|)[^A-z0-9'~!@#$%^&*\-+=<>?/\|[\]:_] 0:function
